...
const Drivers = () => {
              ...
              <div className="flex gap-x-6 sm:gap-x-0 sm:grid justify-between w-full md:w-1/2">
                    <form onSubmit={(e)=>e.preventDefault()} className="flex items-center">
                        ...
                        <div className="relative w-full">
                            ...
                            <input type="text" id="simple-search" className="border  text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 bg-[#353C56] placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500" placeholder="Search" value={searchQuery} onChange={handleSearch} required="" />
                        </div>
                    </form>
  ...
  {filteredData && filteredData.length > 0 ? (
    filteredData.map((data) => (
        ...
        <th scope="row" className="px-4 py-3 font-medium whitespace-nowrap text-white">{data.data.fullName}</th>
