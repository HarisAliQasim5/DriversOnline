...
const HomeFact = () => {
  ...
  return (
    <div className={` ${darkMode ? "bg-dark" : ""} px-4 sm:px-10 pt-20 pb-5 font-serif`}>
      <h1 className="  bg-gradient-to-br from-purple to-magenta text-transparent bg-clip-text font-bold pb-5 text-4xl  italic ">Facts</h1>
