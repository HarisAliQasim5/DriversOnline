...
const Dashboard = () => {
  ...
  <div id="main-wrapper">
      ...
      <p class="brand-title" width="124px" height="33px"  style={{fontSize: "30px"}}>Admin</p>
          </a>
              ...
              <div class="row align-items-center">
                <div class="col-xl-6">
                  <div class="card-bx bg-blue">
                    <img class="pattern-img" src="assets/images/pattern/pattern6.png" alt="" />
                    <div class="card-info text-white">
                      <img src="assets/images/pattern/circle.png" class="mb-4" alt="" />
        ...
        <div class="col-xl-3 col-xxl-7">
          <div class="card">
            ...
            <div class="card-body">  
              ...
              <ul class="user-list">
                <li><img src="assets/images/ion/bussiness-man.png" alt="" /></li>
                <li><img src="assets/images/ion/hacker.png" alt="" /></li>
                <li><img src="assets/images/ion/man (2).png" alt="" /></li>
                <li><img src="assets/images/ion/woman.png" alt="" /></li>
                <li><img src="assets/images/ion/man.png" alt="" /></li>
                <li><img src="assets/images/ion/woman.png" alt="" /></li>
        ...
        <div class="col-xl-3 col-xxl-5">
          <div class="card">
            ...
            <div class="card-body">  
              ...
              <div class="progress default-progress mt-4">
                                  <div class="progress-bar bg-gradient-3 progress-animated" style={{width:"30%", height:"20px"}} role="progressbar">
            ...
            <div class="col-md-6">
              <div class="card progress-card">
                <div class="card-body d-flex">
                  ...
                  <div class="progress progress-vertical-bottom" style={{minHeight:"110px", minWidth:"10px"}}>
