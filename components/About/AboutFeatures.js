    ...
    >
      ...
      >
        <div className="text-center">
          <h1 className="text-3xl  font-bold bg-gradient-to-br from-purple to-magenta text-transparent bg-clip-text mb-8 lg:mb-0">
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-purple">Customizable</h3>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-purple">Fully Responsive</h3>
              <p className={`mt-1 ${darkMode? "text-white" : "text-black"}`}>
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-purple">Developer Support</h3>
              <p className={`mt-1 ${darkMode? "text-white" : "text-black"}`}>
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-purple">Cross Browser</h3>
              <p className={`mt-1 ${darkMode? "text-white" : "text-black"}`}>
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-purple">Clean Code</h3>
              <p className={`mt-1 ${darkMode? "text-white" : "text-black"}`}>
                {" "}
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="font-semibold text-xl text-purple">Well Maintained</h3>
              <p className={`mt-1 ${darkMode? "text-white" : "text-black"}`}>
                {" "}
