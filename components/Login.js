  ...
  <div className="grid md:h-screen md:grid-cols-2">
    ...
    <div className="flex flex-col items-center justify-center bg-white">
      ...
      <div className="max-w-lg px-5 py-16 text-center md:px-10 md:py-24 lg:py-32">
        {/* Title */}
        <h2 className="mb-8 text-3xl font-bold md:mb-12 md:text-5xl">Start your 14-day free trial</h2>
        {/* Form */}
        <form className="mx-auto mb-4 max-w-sm pb-4" name="wf-form-password" method="get">
          ...
          <label className="mb-6 flex items-center pb-12 font-medium lg:mb-1">
            ...
            <span className="ml-4 inline-block cursor-pointer text-sm" htmlFor="checkbox">I agree with the <a href="#" className="font-bold text-[#0b0b1f]">Terms &amp; Conditions</a> </span>
          </label>
          {/* Button */}
          <a href="#" className="flex items-center justify-center bg-[#276ef1] px-8 py-4 text-center font-semibold text-white transition [box-shadow:rgb(171,196,_245)-8px_8px] hover:[box-shadow:rgb(171,_196,_245)_0px_0px]">
        ...
        <p className="text-sm text-[#636262]">Already have an account? <a href="#" className="text-sm font-bold text-black">Login now</a></p>
      </div>
    </div>
    {/* Component */}
    <div className="flex flex-col items-center justify-center bg-[#f2f2f7]">
      ...
      <div className="max-w-lg px-5 py-16 md:px-10 md:py-24 lg:py-32">
        <div className="mb-6 ml-2 flex h-14 w-14 items-center justify-center bg-[#276ef1] [box-shadow:rgb(171,196,_245)-8px_8px]">
