                ...
                <div
                    ...
                    <div>
                        ...
                        <p className="mt-3 sm:mt-4 text-base text-gray-600 dark:text-gray-400">
                            Once we determine your needs, we match you with a selection of drivers chosen just for you
                        </p>
                    </div>
                    <div>
                    <div
                        ...
                        <p className="mt-3 sm:mt-4 text-base text-gray-600 ">
                            Try each potential driver to ensure that the chauffeur you choose is the perfect for you. 
                        </p>
                    </div>
                    <div>
                    <div
                        ...
                        <p className="mt-3 sm:mt-4 text-base text-gray-600 ">
                            Have the same driver every time. The reliability of a familiar face in the comfort of your own car
                        </p>
                    </div>
                </div>
            </div>
